...
function render_layout(string $title, string $pageKey, callable $content, array $user): void {
    $base    = BASE_PATH;
    $accent  = Settings::get('general.accent_color') ?: 'blue';
    $defMode = Settings::get('general.default_mode')  ?: 'dark';
    ...
    ?>
<!DOCTYPE html>
<html lang="en" data-bs-theme="dark" data-accent="<?= h($accent) ?>">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="base-path" content="<?= $base ?>">
<title><?= h($title) ?> — <?= APP_NAME ?></title>
<script>/* Prevent theme flash */(function(){var t=localStorage.getItem('pbx-theme')||'<?= $defMode ?>';document.documentElement.setAttribute('data-bs-theme',t);})();</script>
