...
$routes = [
    ...
    '/whatsapp'           => 'whatsapp',
    '/settings'           => 'freepbx-settings',  // admin only — enforced below
];
...
// Admin-only pages
if ($page === 'freepbx-settings' && ($user['role'] ?? '') !== 'admin') {
    http_response_code(403);
    echo '<!DOCTYPE html><html><body style="background:var(--body-bg,#0a0f1e);color:#e2e8f0;font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;margin:0"><div style="text-align:center"><h1 style="font-size:48px;color:#f87171">403</h1><p>Access denied — admin only</p><a href="' . BASE_PATH . '/" style="color:#38bdf8">Go home</a></div></body></html>';
    exit;
}
