...
<style>
.nav-tabs { border-color: #1a2540; }
.nav-tabs .nav-link { color: #94a3b8; border-color: transparent; background: none; }
.nav-tabs .nav-link:hover { color: #e2e8f0; border-color: transparent; background: #111827; }
.nav-tabs .nav-link.active { color: #60a5fa; border-color: #1a2540 #1a2540 #0a0f1e; background: #0a0f1e; }
.card-footer { background: #0d1526 !important; }
</style>
